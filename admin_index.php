        ...
        <?php
                ...
                <div class="menu-right">
                    ...
                    <ul id="menu">
                        ...
                        <li><a class="hover_ele" id="Requests" href="Requests_list.php">Requests</a></li>
                        <li><a class="hover_ele" id="feedbacks" href="feedbacks_list.php">feedbacks</a></li>
                        <li class="hover_ele2" ><a id="Banks" href="bank_list.php">Banks</a></li>';
